          ...
          <template v-for="project of store.projects" :key="project.id">
            ...
            >
              <div class="flex justify-between items-center mb-5 text-gray-500">
                <span
                  class="bg-emerald-100 text-emerald-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800"
                >
                  {{ project.development }}
                </span>
                <span
                  class="text-sm text-transparent bg-clip-text bg-emerald-700"
              ...
              <p class="mb-5 font-light text-black dark:text-gray-400">
                {{ project.description }}
              </p>
              <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                  <button
                    ...
                    class="flex justify-center items-center text-black transition ease-in-out delay-50 bg-white hover:-translate-y-1 hover:scale-110 focus:outline-none hover:bg-emerald-100 focus:ring-4 font-medium rounded-full text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600"
                  >
                    <img
